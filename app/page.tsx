    ...
    <div>
      <div className="px-[5vw] md:px-[20vw] lg:px-[30vw] py-10 flex flex-col gap-6">
        <div className="flex items-center gap-4">
          <p className="text-xl md:text-2xl font-semibold text-brand" style={blackInter.style}>
            Hi, I&apos;m Regis <span className="opacity-20">#</span>
          </p>
        </div>
        <div className="flex flex-col gap-6">
          <P>
            I&apos;m Regis and I&apos;m a software engineer, a UXologist, a mentor, and tech-blogger. My current focus is building high experience software applications and coding tools.
          </P>
          <P>
        ...
        <div className="mt-10">
          <p className="text-xl mb-4 md:text-2xl font-semibold text-brand" style={blackInter.style}>
          ...
          <div className="mt-6">
            {works.map((work, index) => (
              <Link key={index} href={work.href} className="w-full hover:bg-[#00000003] hover:px-1 transition-all duration-50 px-0 border-y py-2 border-slate-10 justify-between flex items-center">
                <P>
                  {work.name}
                </P>
