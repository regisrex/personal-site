...
const buttonVariants = cva(
  "text-center justify-center bg-white flex items-center gap-2  rounded-full   px-6 py-3 disabled:opacity-80 duration-200",
  {
    variants: {
      variant: {
        primary:
          "bg-black/90 text-white hover:opacity-90",
          linkButton:
          "bg-transparent  text-sm text-slate-600 rounded-none hover:opacity-90 px-0 hover:underline underline-offset-4",
        secondary:
          "bg-brand-darkblue-10   text-brand  text-brand bg-brand/10  hover:bg-white ",
        tertiary:
          "bg-transparent  text-brand-darkblue  hover:bg-white border border-brand/40 text-brand ",
        ondark:
          "bg-brand-white-10  text-white hover:bg-white hover:text-brand-darkblue",
...
const Button: FC<ButtonProps> = ({
  ...
  return (
    ...
    >
      {loading &&
        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" className="animate-spin">
          <defs>
